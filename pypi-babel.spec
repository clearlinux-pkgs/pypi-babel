...
Source0  : https://files.pythonhosted.org/packages/15/d2/9671b93d623300f0aef82cde40e25357f11330bdde91743891b22a555bed/babel-2.15.0.tar.gz
...
%prep
%setup -q -n babel-2.15.0
cd %{_builddir}/babel-2.15.0
pushd ..
cp -a babel-2.15.0 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1715013906
