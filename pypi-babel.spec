...
Source0  : https://files.pythonhosted.org/packages/ff/80/45b42203ecc32c8de281f52e3ec81cb5e4ef16127e9e8543089d8b1649fb/Babel-2.11.0.tar.gz
...
%prep
%setup -q -n Babel-2.11.0
cd %{_builddir}/Babel-2.11.0
pushd ..
cp -a Babel-2.11.0 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1672258465
...
cp %{_builddir}/Babel-%{version}/LICENSE %{buildroot}/usr/share/package-licenses/pypi-babel/7c9a6510a05316ed0c5ee85cedee5044fd33bfc2 || :
...
/usr/share/package-licenses/pypi-babel/7c9a6510a05316ed0c5ee85cedee5044fd33bfc2
