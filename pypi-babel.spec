...
%prep
%setup -q -n babel-2.16.0
cd %{_builddir}/babel-2.16.0
pushd ..
cp -a babel-2.16.0 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1723138300
...
cp %{_builddir}/babel-%{version}/LICENSE %{buildroot}/usr/share/package-licenses/pypi-babel/9da3d392c070bd444643839957cecfd15e5c4501 || :
...
/usr/share/package-licenses/pypi-babel/9da3d392c070bd444643839957cecfd15e5c4501
