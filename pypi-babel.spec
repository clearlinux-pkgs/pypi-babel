...
Source0  : https://files.pythonhosted.org/packages/b0/91/c521fa4102ef9afc8c9f64d1828993d39b7e99944d40a76d4ef94f6321b2/Babel-2.10.2.tar.gz
...
%prep
%setup -q -n Babel-2.10.2
cd %{_builddir}/Babel-2.10.2
pushd ..
cp -a Babel-2.10.2 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1655254551
...
cp %{_builddir}/Babel-2.10.2/LICENSE %{buildroot}/usr/share/package-licenses/pypi-babel/461006fda89ca3bf051ce8ff474915073c065b69
cp %{_builddir}/Babel-2.10.2/docs/_themes/LICENSE %{buildroot}/usr/share/package-licenses/pypi-babel/d0eff60551064b040266867c393e035d747b0ae5
cp %{_builddir}/Babel-2.10.2/docs/license.rst %{buildroot}/usr/share/package-licenses/pypi-babel/11b5e2224ed952488aa2abbd6c9f41c64a7eca3e
