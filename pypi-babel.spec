...
Source0  : https://files.pythonhosted.org/packages/7d/6b/d52e42361e1aa00709585ecc30b3f9684b3ab62530771402248b1b1d6240/babel-2.17.0.tar.gz
...
%prep
%setup -q -n babel-2.17.0
cd %{_builddir}/babel-2.17.0
pushd ..
cp -a babel-2.17.0 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1738599841
